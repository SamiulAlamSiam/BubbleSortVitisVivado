...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sub i32 %%1, %%storemerge3, !dbg !4 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_35_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = add nsw i32 %%storemerge3, 1, !dbg !4 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_57_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = sext i32 %%storemerge12 to i64, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_38_count);
  llvm_cbe_tmp__5 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = getelementptr inbounds i32* %%arr, i64 %%5, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_39_count);
  llvm_cbe_tmp__6 = (signed int *)(&llvm_cbe_arr[(((signed long long )llvm_cbe_tmp__5))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__5));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = load i32* %%6, align 4, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__7 = (unsigned int )*llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__7);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = add nsw i32 %%storemerge12, 1, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_41_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = sext i32 %%8 to i64, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_42_count);
  llvm_cbe_tmp__9 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%10 = getelementptr inbounds i32* %%arr, i64 %%9, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__10 = (signed int *)(&llvm_cbe_arr[(((signed long long )llvm_cbe_tmp__9))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__9));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = load i32* %%10, align 4, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_44_count);
...
printf("\n\{ BEGIN @group3\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @bubbleSort(i32* %%array, i32 %%array_size), !dbg !3 for 0x%I64xth hint within @group3  --> \n", ++aesl_llvm_cbe_72_count);

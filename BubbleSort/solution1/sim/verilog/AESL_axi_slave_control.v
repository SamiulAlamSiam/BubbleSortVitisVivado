        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_array_r_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    if(image_mem_array_r[write_array_r_count * four_byte_num  + i]!==array_r_data_tmp_reg) begin
                    write (array_r_data_in_addr + write_array_r_count * four_byte_num * 4 + i * 4, array_r_data_tmp_reg, write_array_r_resp);
                    image_mem_array_r[write_array_r_count * four_byte_num + i]=array_r_data_tmp_reg;
                    end
                end
                process_busy = 0;
